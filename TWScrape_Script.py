...
api_keys_path = Path("YOUR PATH TO API KEYS FILE(S) HERE")
directory_path = Path("PATH TO FOLDER WITH THE DATABASE")
db_path = directory_path/"DB_NAME_HERE.db"

######## SET API CREDENTIALS - I STORE EACH AS SEPARATE .TXT FILE#####
...
###############################################################################
## NOTE: set up your client as "client", and keep wait on rate limit as TRUE ##
###############################################################################
